...
public class RTSPMultiStreamCVCudaMjpegHandler<T> implements  IVisualStreamHandler<T>  {

	// Note: CUDA not supported on NANO do not use

//	private static final long       DEFAULT_VIDEO_RATE_NS  = 66_400_000;
	private static final long       DEFAULT_VIDEO_RATE_NS  = 40_000_000;
	...
	public RTSPMultiStreamCVCudaMjpegHandler(IMAVController control,int width, int height, DataModel model) {
		...
		image_mat = new GpuMat(height,width, CvType.CV_8UC3);
	...
	public static void main(String argv[]) throws Exception
	{
		...
		RTSPMultiStreamCVCudaMjpegHandler<Planar<GrayU8>> server = new RTSPMultiStreamCVCudaMjpegHandler<Planar<GrayU8>>(null,640,480, new DataModel());
