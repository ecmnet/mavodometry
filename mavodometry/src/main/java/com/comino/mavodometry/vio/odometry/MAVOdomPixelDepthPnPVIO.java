 ...
 * @author Peter Abeles
 */
public class MAVOdomPixelDepthPnPVIO<T extends ImageBase<T>> {
	 ...
	 */
	public MAVOdomPixelDepthPnPVIO(int thresholdAdd,
								int thresholdRetire ,
								boolean doublePass ,
...
//		System.out.println("----------- Adding new tracks ---------------");
	...
	private boolean estimateMotion() {
		...
		if(active.size()> 0)
		    quality = motionEstimator.getFitQuality() * 100 /active.size();
		else
			quality = 0;
