 ...
 */
public class MAVOdomPixelDepthPnPVIO2<T extends ImageBase<T>>  {
	 ...
	 */
	public MAVOdomPixelDepthPnPVIO2(int thresholdAdd, int thresholdRetire, boolean doublePass, Point3D_F64 offset,
			ModelMatcher<Se3_F64, Point2D3D> motionEstimator, ImagePixelTo3D pixelTo3D, RefinePnP refine,
			PointTrackerTwoPass<T> tracker, Point2Transform2_F64 pixelToNorm, Point2Transform2_F64 normToPixel) {
